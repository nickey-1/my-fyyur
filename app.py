...
def show_venue(venue_id):
  ...
  data = {
    ...
    "past_shows_count": len(past_shows_arr),
    "upcoming_shows_count": len(upcoming_shows_arr),
  }
...
def edit_artist(artist_id):
  ...
  #   "seeking_venue": True,
  #   "seeking_description": "Looking for shows to perform at in the San Francisco Bay Area!",
  #   "image_link": "https://images.unsplash.com/photo-154213783-8284d0336c4f?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=300&q=80"
  # }
